    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link" href="${rootpath}list-category"
                ...
                <li class="sidebar-item">
                	<a class="sidebar-link sidebar-link" href="${rootpath}list-product/1" aria-expanded="false">
